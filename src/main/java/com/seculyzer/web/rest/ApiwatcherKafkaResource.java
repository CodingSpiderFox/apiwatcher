...
import com.seculyzer.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/apiwatcher-kafka")
public class ApiwatcherKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ApiwatcherKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public ApiwatcherKafkaResource(KafkaProperties kafkaProperties) {
